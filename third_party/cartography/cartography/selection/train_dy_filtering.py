...
def write_filtered_data(args, train_dy_metrics):
  ...
  for fraction in [0.3319]: # [0.01, 0.05, 0.10, 0.1667, 0.25, 0.3319, 0.50, 0.75]:
    ...
    num_samples = 100000 # int(fraction * len(train_numeric))
...
if __name__ == "__main__":
  ...
  train_dy_metrics.to_pickle('eval.pkl')
